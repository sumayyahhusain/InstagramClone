# Project 3 - *InstagramClone* - Unit 5
...
# Project 3 - *InstagramClone* -  Unit 6
...
- [x] User can see Instagram app icon from homescreen!

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='InstagramCloneWalkthrough2.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

This assignment is being submitted late. I had a lot of errors throughout unit 6. I noticed that the video wallkthrough's on CodePath are pretty outdated making it hard for students to follow along. 
